...
class InstaDataImportShell extends AppShell {
	// ロードモデル
	...
	public function main() {
		...
		$this->out( 'End InstaImport.' );
	}
	
	public function checkTest(){
		$this->out( 'function Start . => '.date('Y/m/d h:i:s') );
		
		$this->out( 'run checkTest' );
		
		$this->out( 'function End . => '.date('Y/m/d h:i:s') );
	}
}
?>